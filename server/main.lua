...
RegisterNetEvent('qb-multicharacter:server:loadUserData', function(cData)
    ...
    if QBCore.Player.Login(src, cData.citizenid) then
        ...
        if Config.SkipSelection then
            ...
            if Config.UseApartments and GetResourceState('qb-apartments') == 'started' then
...
RegisterNetEvent('qb-multicharacter:server:createCharacter', function(data)
    ...
    if QBCore.Player.Login(src, false, newData) then
        ...
        until hasDonePreloading[src]
        -- ======================================================
        -- Config.UseApartments = true  >> يرسل للشقة
        -- Config.UseApartments = false >> يرسبن في DefaultSpawn
        -- ======================================================
        if Config.UseApartments and GetResourceState('qb-apartments') == 'started' and Apartments.Starting then
